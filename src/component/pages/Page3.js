...
<a style={{marginLeft:"8px"}} href="https://www.linkedin.com/feed/"target="_blank"rel="noopener noreferrer">LinkDin</a>
               ...
               <table style={{border:"1px solid black",borderCollapse:"collapse",marginLeft:"600px",marginTop:"200px"}}>
                   <tr>
                       <th style={{padding:"20px",position:"left"}}>Permanant Addres:</th>
                       <td style={{padding:"5px",position:"left"}}>   Basenterpara, Jumarbari,Shagata,Gaibandha</td>
                   </tr>
                   <tr>
                       <th style={{padding:"20px",position:"left"}}>Present Address:</th>
                       <td style={{padding:"20px",position:"left"}}>Nikunjo-2, Khilkhet, Dhaka</td>
                   </tr>
                   <tr>
                       <th style={{padding:"20px",position:"left"}}>Phone: </th>
                       <td style={{padding:"20px",position:"left"}}>01717374348</td>
                   </tr>
                   <tr>
                       <th style={{padding:"20px",position:"left"}}>Email:</th>
                       <td style={{padding:"20px",position:"left"}}><a href="https://mail.google.com/mail/u/0/#inbox"target="_blank"rel="noopener noreferrer">masrafianam@gmail.com</a></td>
                   </tr>
               </table>
            </span>
        );
